                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="footer-list-contact">
                            <li>
                                ...
                                <a href="#">{{ $setting ? $setting->address : 'Default Address' }}</a>
                            </li>
                            <li>
                                <i class='bx bx-phone-call'></i>
                                <a href="tel:{{ $setting ? $setting->phone : '000-000-0000' }}">{{ $setting ? $setting->phone : '000-000-0000' }}</a>
                            </li>
                            <li>
                                <i class='bx bx-envelope'></i>
                                <a href="mailto:{{ $setting ? $setting->email : 'info@example.com' }}">{{ $setting ? $setting->email : 'info@example.com' }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <div class="copy-right-text text-align1">
                        <p>
                            {{ $setting ? $setting->copyright : 'Default Copyright' }}
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="social-icon text-align2">
                        <ul class="social-link">
                            <li>
                                <a href="{{ $setting ? $setting->facebook : '#' }}" target="_blank"><i class='bx bxl-facebook'></i></a>
                            </li>
                            <li>
                                <a href="{{ $setting ? $setting->twitter : '#' }}" target="_blank"><i class='bx bxl-twitter'></i></a>
                            </li>
                            <li>
